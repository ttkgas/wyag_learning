...
argparser = argparse.ArgumentParser(description='Wyag - my vcs')
...
class GitObject(object):
    ...
    def serialize(self, repo):
        ...
        raise Exception("Unimplemented method serialize")
    
    def deserialize(self, data):
        "This function MUST be implemented by subclasses"
        raise Exception("Unimplemented method deserialize")

    def init(self):
        "This function MAY be implemented by subclasses to initialize an object"
        pass
...
def tree_serialize(obj):
    ...
    for i in obj.items:
        ret += i.mode + b' ' + i.path.encode() + b'\x00'
        sha = int(i.sha, 16)
...
argsp.add_argument("-r", dest="recursive", 
                   action="store_true",
...
def tag_create(repo, name, ref, create_tag_object=False):
    ...
    if create_tag_object:
        ...
        tag.kvlm[None] = b'A tag generated by wyag, which wont let you customize the message!\n'
